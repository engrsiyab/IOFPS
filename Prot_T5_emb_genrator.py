...
DEFAULT_BATCH_SIZE = 8  # Reduced from 32 to avoid OOM
MAX_LEN = 1024
        ...
        try:
            if self.use_t5_encoder:
                try:
                    ...
                    # Fallback to AutoTokenizer if T5Tokenizer fails (common with some custom models)
            ...
            # DISABLE half precision for T5 models (ANKH, ProtT5) as it causes NaNs on some GPUs
            if self.device == "cuda" and not self.use_t5_encoder:
                self.model.half()
...
def run_pipeline(file_path):
    ...
    # 2. Define Models
    models_to_run = [
        # ProtT5 (Rostlab) - Requires spaces, T5-based
        ProteinEmbedder(
            model_name="Rostlab/prot_t5_xl_uniref50", 
            output_name="_try_emb_test_prott5", 
...
if __name__ == "__main__":
    ...
    STATIC_FILE_PATH = "/kaggle/input/datasets/engrsiyab/try-001/test.xlsx"
